...
int main() {
  ...
  try {
    ...
    while (number_of_boids <= 0) {
      std::cout << "Invalid Boids' number, please try again... \n";
      std::cin >> number_of_boids;
    }
    ...
    double param_ds{};
    std::cin >> param_ds;
    while (param_ds < 10 || param_ds > 25. || param_ds > param_d) {
      std::cout << "Invalid parameter, please try again... \n";
      std::cin >> param_ds;
    }
    ...
    while (boids_view_angle < 0 || boids_view_angle > 180.) {
      std::cout << "Invalid Boid's wiew angle, please try again... \n";
      std::cin >> boids_view_angle;
    }
    ...
    while (number_of_obstacles < 0) {
      std::cout << "Invalid number of obstacles, please try again... \n";
      std::cin >> number_of_obstacles;
    }
    ...
    while (obstacles_max_size <= 15. || obstacles_max_size > 70.) {
      std::cout << "Invalid parameter, please try again... \n";
      std::cin >> obstacles_max_size;
    }
    ...
    while (number_of_predators <= 0) {
      std::cout << "Invalid number of predators, please try again... \n";
      std::cin >> number_of_predators;
    }
    ...
    while (preds_view_angle < 0 || preds_view_angle > 180.) {
      std::cout << "Invalid parameter, please try again... \n";
      std::cin >> preds_view_angle;
    }
    ...
    double preds_range;
    std::cin >> preds_range;
    while (preds_range <= 0 || preds_range > 90.) {
      std::cout << "Invalid parameter, please try again... \n";
      std::cin >> preds_range;
    }
    ...
    while (preds_hunger <= 0 || preds_hunger > 2) {
      std::cout << "Invalid parameter, please try again... \n";
      std::cin >> preds_hunger;
    }
    ...
    std::cin >> bhrv;
    while (bhrv != 0 && bhrv != 1) {
      std::cout << "Invalid decision, please try again... \n";
      std::cin >> bhrv;
    };
