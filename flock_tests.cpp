...
TEST_CASE("Testing the Flock::sort method") {
  ...
  // FLCOK CONSTRUCTOR takes: params, number_of_boids, view_angle,
  // window_space{1920., 1080.};

  SUBCASE("Testing the Flock::sort method with five boids boids") {
    bd::Boid bd_1(1, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(4, 3, -2, 9, 120., 1920, 1080, 4, 1);
    bd::Boid bd_3(0, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_4(54, 3, -2, 9, 120., 1920, 1080, 4, 1);

    fk::Parameters params(4, 4, 1, 2, 3);
  ...
  SUBCASE("Testing the Flock::sort method with boids with same x_position") {
    bd::Boid bd_1(1, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(4, 3, -2, 9, 120., 1920, 1080, 4, 1);
    bd::Boid bd_3(10, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_4(10, 3, -2, 9, 120., 1920, 1080, 4, 1);
...
TEST_CASE("Testing the Flock::update_com method") {
  ...
  SUBCASE("Testing the Flock::update_com method with four boids") {
    ...
    bd::Boid bd_2(5, 7, 1, -3, 120., 1920, 1080, 4, 1);
    bd::Boid bd_3(6, 8, 4, 3, 120., 1920, 1080, 4, 1);
    bd::Boid bd_4(10, 12, -4, 8, 120., 1920, 1080, 4, 1);
  ...
  SUBCASE("Testing the Flock::update_com method with two boids") {
    bd::Boid bd_1(0, 0, 0, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(0, 0, 0, 0, 120., 1920, 1080, 4, 1);
...
TEST_CASE("Testing the Flock::get_neighbours method") {
  ...
  SUBCASE("Testing the Flock::get_neighbours method with four boids") {
    bd::Boid bd_1(1, 4, 5, 0, 120., 1920., 1080., 4., 1.);
    bd::Boid bd_2(3, 3, -2, 9, 120., 1920, 1080, 4, 1);
    bd::Boid bd_3(10, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_4(10, 3, -2, 9, 120., 1920, 1080, 4, 1);

    fk::Parameters params(2.5, 4, 1, 2, 3);
    ...
    auto it = flock.begin();
    ++it;
    std::vector<bd::Boid> neighbours = flock.get_neighbours(it);
  ...
  SUBCASE("Testing the Flock::get_neighbours method again with four boids ") {
    bd::Boid bd_1(1., 4., 5., 0., 150., 1920., 1080., 4., 1.);
    bd::Boid bd_2(3, 3, -2, 9, 150., 1920, 1080, 4, 1);
    bd::Boid bd_3(4, 4, 5, 0, 150., 1920, 1080, 4, 1);
    bd::Boid bd_4(6, 7, -2, 9, 150., 1920, 1080, 4, 1);

    fk::Parameters params(5, 4, 1, 2, 3);

    fk::Flock flock(params, 0, 150., {1920, 1080});
  ...
  SUBCASE(
      ...
      "see "
      "each other") {
    bd::Boid bd_1(7, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(4, 3, -5, 0, 120., 1920, 1080, 4, 1);
  ...
  SUBCASE(
    ...
    bd::Boid bd_1(1, 1, 1, 1, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(3, 3, 1, 1, 120., 1920, 1080, 4, 1);
    bd::Boid bd_3(4, 4, 1, 1, 120., 1920, 1080, 4, 1);
    bd::Boid bd_4(6, 7, 1, 1, 120., 1920, 1080, 4, 1);
    ...
    std::vector<bd::Boid> neighbours_1 = flock.get_neighbours(it);
    std::vector<bd::Boid> neighbours_2 = flock.get_neighbours(ut);
  ...
  SUBCASE("Testing the Flock::get_neighbours method with Flock::end") {
    bd::Boid bd_1(1, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(3, 3, -2, 9, 120., 1920, 1080, 4, 1);
    bd::Boid bd_3(4, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_4(6, 7, -2, 9, 120., 1920, 1080, 4, 1);
...
TEST_CASE("Testing the Flock::vel_correction method without predator") {
  ...
  SUBCASE(
      ...
      "doesn't see the others") {
    bd::Boid bd_1(1, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(3, 3, 5, 9, 120., 1920, 1080, 4, 1);
    bd::Boid bd_3(4, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_4(6, 7, 5, 0, 120., 1920, 1080, 4, 1);
...
TEST_CASE("Testing the Flock::vel_correction method with predator") {
  ...
  // FLOCK CONSTRUCTOR takes: params, number_of_boids, view_angle,
  // window_space{1920., 1080.};
  ...
  SUBCASE(
    ...
    pr::Predator pd(1., 1., 2., 2., 140., 1920., 1080., 4., 1., 5., 1.);
  ...
  SUBCASE(
    ...
    bd::Boid bd_3(4, 4, 5, 0, 120., 1920, 1080, 4, 1);  // pd out of range
    bd::Boid bd_4(6, 7, 5, 0, 120., 1920, 1080, 4, 1);  // pd NOT out of range

    pr::Predator pd(8., 14., -5., -5., 140., 1920., 1080., 4., 1., 5., 1.);
  ...
  SUBCASE(
    ...
    pr::Predator pd1(4., 8., -5., -5., 140., 1920., 1080., 4., 1., 5., 1.);
    pr::Predator pd2(10., 8., -5., -5., 140., 1920., 1080., 4., 1., 5., 1.);
...
TEST_CASE("Testing the Flock::avoid_pred method") {
  ...
  // Pos {x,y}, Vel{x,y}, view_angle, window_space{1920, 1080}, param_ds_,
  // param_s, p_range, p_hunger
  // avoid_pred takes: boid, predator,boid_pred_detection, boid_pred_repulsion
  ...
  bd::Boid bd({10., 15.}, {2., 2}, 120., {1920., 1080.}, 5., 4.);
  fk::Parameters params(10., 5., 4., 3., 2.);
  fk::Flock flock(params, 0., 120., {1920., 1080.});
  flock.push_back(bd);
  pr::Predator pd(14., 17., -2., -1, 120., 1920., 1080., 6., 4., 5., 2.);
  std::valarray<double> delta_vel = flock.avoid_pred(bd, pd, 2., 2.);
  CHECK(delta_vel[0] == -32.);
  CHECK(delta_vel[1] == -16.);
}
...
TEST_CASE("Testing the Flock::Update_stats method") {
  ...
  SUBCASE("Testing the Flock::update_stats method with no neighbours") {
    bd::Boid bd_1(1, 4, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(10, 6, 2, 0, 120., 1920, 1080, 4, 1);

    fk::Parameters params(3, 4, 1, 2, 3);
  ...
  SUBCASE("Testing the Flock::update_stats method with boids") {
    bd::Boid bd_1(1, 1, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_2(2, 2, -2, 9, 120., 1920, 1080, 4, 1);
    bd::Boid bd_3(3, 3, 5, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_4(4, 4, -2, 9, 120., 1920, 1080, 4, 1);

    fk::Parameters params(10, 4, 1, 2, 3);
  ...
  SUBCASE("Testing the Flock::update_stats method with boids") {
    ...
    bd::Boid bd_4(1, 1, 0, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_5(4, 1, 0, 0, 120., 1920, 1080, 4, 1);
    bd::Boid bd_6(2, 3, 0, 0, 120., 1920, 1080, 4, 1);

    fk::Parameters params(10, 4, 1, 2, 3);

    fk::Flock flock_1(params, 0, 120., {1920, 1080});
    fk::Flock flock_2(params, 0, 120., {1920, 1080});
